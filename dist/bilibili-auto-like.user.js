 ...
 * 实测结果：低等级的号每小时限制200赞，高等级号暂时没触发过限制
 * ============================================================ */
...
const LIKE_FAIL_DELAY_BASE = 30000;       // 点赞失败后同轮内基础延迟(ms)
const LIKE_FAIL_DELAY_MAX  = 300000;      // 点赞失败后同轮内最大延迟(ms)
const FAIL_STREAK_GLOBAL_THRESHOLD = 5;  // 连续失败达到此值触发全局退避
const FAIL_STREAK_GLOBAL_BASE = 1800 * 1000;  // 全局退避基础
const FAIL_STREAK_GLOBAL_MAX  = 6 * 3600 * 1000; // 全局退避最大
